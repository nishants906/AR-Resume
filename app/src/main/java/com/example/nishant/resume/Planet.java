...
public class Planet extends Node implements Node.OnTapListener {
  ...
  ViewRenderable descriptionRenderable;
...
//  }
  public Planet(
          ...
          String planetName,
          float planetScale,
          ViewRenderable planetRenderable,
          SolarSettings solarSettings) {
    this.context = context;
    this.planetName = planetName;
    this.planetScale = planetScale;
    this.descriptionRenderable = planetRenderable;
    this.solarSettings = solarSettings;
    setOnTapListener(this) ;
  }
  ...
  public void onActivate() {
    ...
    if (planetVisual == null) {
      planetVisual = new RotatingNode(false);
      planetVisual.setParent(this);
      planetVisual.setRenderable(descriptionRenderable);
